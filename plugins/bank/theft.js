...
const handler = async (m, { conn }) => {
    ...
    if (!success) {
        ...
        const pic = await conn.profilePictureUrl(m.sender, 'image').catch(() => 'https://i.postimg.cc/PxcS6SvT/d7e8080a5326b0d93e36d85d4a897f8d.jpg');
...
╰─┈─┈─⟞🤡⟝─┈─┈─╯`,
    ...
    if (userTarget.xp < stealAmount) {
        ...
        userTarget.xp = 0;
        const pic = await conn.profilePictureUrl(m.sender, 'image').catch(() => 'https://i.postimg.cc/RFqPQkhZ/8653766a329a5a5a714e221e9aa67e3a.jpg');
        await conn.sendMessage(m.chat, {
            image: { url: pic },
            caption: `╭─┈─┈─⟞💰⟝─┈─┈─╮
┃ ✅ نـجـحـت الـسـرقـة
...
╰─┈─┈─⟞🤡⟝─┈─┈─╯`,
    ...
    const pic = await conn.profilePictureUrl(m.sender, 'image').catch(() => 'https://i.postimg.cc/hjhCbkvR/b6d11b7bf177e610e41d4349acb61f20.jpg');
    await conn.sendMessage(m.chat, {
        image: { url: pic },
        caption: `╭─┈─┈─⟞💰⟝─┈─┈─╮
┃ ✅ نـجـحـت الـسـرقـة
