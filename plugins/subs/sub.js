...
const Func = {
  pair: async (conn, code, num, m, reply_status) => {
    await conn.sendButton(m.chat, {
      imageUrl: "https://i.postimg.cc/NMLN73FQ/328bf8cccafe63879d903f2b99d835a0.jpg",
...
> *_افتح واتساب > الأجهزة المرتبطة > ربط جهاز برقم الهاتف > أدخل الكود_*`,
      footerText: "@𝑺𝒚𝒔𝒕𝒆𝒎_𝑺𝒖𝒃𝑩𝒐𝒕𝒔_𝐄𝐒𝟏",
      buttons: [
        { name: "cta_copy", params: { display_text: "⟨📋| 𝐂𝐨𝐩𝐲 𝐂𝐨𝐝𝐞 |📋⟩", copy_code: code } },
        { name: "cta_url", params: { display_text: "⟨👨🏻‍💻| 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐄𝐒 |👨🏻‍💻⟩", url: "https://whatsapp.com/channel/0029VbBbvWcJ3jv1T55BmR0f" } },
      ],
      mentions: [m.sender],
      newsletter: {
        name: '𝐄𝐒𝟏 ~ 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 🕷️',
